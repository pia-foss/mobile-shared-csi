...
enum class ProviderType(
    ...
    EXPERIMENTS_INFORMATION(printName = "Experiments information")
}
...
public class CSIBuilder {
     ...
     */
    fun setUserAgent(userAgent: String): CSIBuilder = apply { this.userAgent = userAgent }
    ...
    fun build(): CSIAPI {
        ...
        val userAgent = this.userAgent ?: throw Exception("User-Agent value missing.")
        ...
        return CSI(userAgent, teamIdentifier, clientEndpointProvider, listLogProviders, appVersion, certificate)
    }
}
